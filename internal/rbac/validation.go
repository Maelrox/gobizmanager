...
const (
	MsgRootAccessDenied    = "ROOT_ACCESS_DENIED"
	MsgRootRoleAssignment  = "ROOT_ROLE_ASSIGNMENT"
	MsgRoleCompanyMismatch = "ROLE_COMPANY_MISMATCH"
)

// NewError creates a new error with the given type, code, and message
func NewError(errorType ErrorType, code ErrorCode, message string) *errors.Error {
	return &errors.Error{
