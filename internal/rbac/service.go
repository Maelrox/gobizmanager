...
func (s *Service) newError(ctx context.Context, errorType errors.ErrorType, code errors.ErrorCode, msgKey string) *errors.Error {
	return errors.NewError(errorType, code, s.val.MsgStore.GetMessage(GetLanguage(ctx), msgKey))
}
